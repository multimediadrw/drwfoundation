  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        {/* Kenapa DRW Foundation - Enhanced */}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                >
                  <div className={`w-16 h-16 bg-gradient-to-br ${program.color} rounded-2xl flex items-center justify-center mb-4 text-3xl group-hover:scale-110 transition-transform shadow-lg`}>
                    {program.icon}
                  </div>
        ...
        {/* Kegiatan DRW Foundation Gallery */}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
              ...
              <div className="relative h-64 rounded-xl overflow-hidden shadow-lg group">
                <Image
                  src="/images/kegiatan/bersholawat_1.png"
                  alt="DRW Bersholawat - Kegiatan Sholawat Akbar"
                  fill
              ...
              <div className="relative h-64 rounded-xl overflow-hidden shadow-lg group">
                <Image
                  src="/images/kegiatan/bersholawat_2.png"
                  alt="DRW Bersholawat - Acara Sholawat"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-300"
                />
              </div>
              <div className="relative h-64 rounded-xl overflow-hidden shadow-lg group">
                <Image
                  src="/images/kegiatan/bersholawat_3.png"
              ...
              <div className="relative h-64 rounded-xl overflow-hidden shadow-lg group">
                <Image
                  src="/images/kegiatan/bersholawat_4.png"
              ...
              <div className="relative h-64 rounded-xl overflow-hidden shadow-lg group">
                <Image
                  src="/images/kegiatan/kebakaran_kutoarjo_1.jpg"
                  alt="Peduli Kebakaran Kutoarjo - Penyaluran Bantuan"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-300"
                />
              </div>
              <div className="relative h-64 rounded-xl overflow-hidden shadow-lg group">
                <Image
                  src="/images/kegiatan/kebakaran_kutoarjo_2.jpg"
                  alt="Peduli Kebakaran Pasar Kutoarjo"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-300"
                />
              </div>
              <div className="relative h-64 rounded-xl overflow-hidden shadow-lg group">
                <Image
                  src="/images/kegiatan/masjid_glowing_1_croped1.jpg"
              ...
              <div className="relative h-64 rounded-xl overflow-hidden shadow-lg group">
                <Image
                  src="/images/kegiatan/DSC01031-1-768x512.jpg"
            ...
            <div className="text-center">
              <p className="text-gray-700 mb-6">
                Cek kegiatan lain <span className="font-bold text-purple-700">DRW Foundation</span> di Official Social Media Kami
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <a
                  href="https://www.instagram.com/drwfoundation/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
                ...
                <a
                  href="https://www.tiktok.com/@drwfoundation"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-8 py-3 bg-black text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  href="https://www.youtube.com/@drwfoundation"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-8 py-3 bg-red-600 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* CTA Section */}
        <section className="relative py-20 bg-gradient-to-br from-purple-700 via-purple-600 to-pink-500 text-white overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/tentang"
                className="inline-flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-md border-2 border-white/30 text-white font-bold rounded-xl transition-all duration-300 hover:bg-white/20 hover:scale-105"
              >
                Tentang Kami
              </Link>
            </div>
