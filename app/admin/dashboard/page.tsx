      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link
              href="/admin/tentang"
              className="flex items-center gap-3 p-4 border-2 border-yellow-200 rounded-lg hover:border-yellow-600 hover:bg-yellow-50 transition group"
            >
              <div className="bg-yellow-100 p-2 rounded-lg group-hover:bg-yellow-600 transition">
              ...
              <div>
                <p className="font-semibold text-gray-900">Edit Tentang</p>
                <p className="text-sm text-gray-600">Kelola halaman tentang</p>
              </div>
            </Link>
          </div>
        </div>
