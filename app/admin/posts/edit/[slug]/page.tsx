    ...
    try {
      ...
      if (data.success) {
        ...
        if (frontmatterMatch) {
          ...
          // Parse frontmatter f          const titleMatch = frontmatterText.match(/title:\s*"([^"]*)"/)\n          const dateMatch = frontmatterText.match(/date:\s*"([^"]*)"/)\n          const excerptMatch = frontmatterText.match(/excerpt:\s*"([^"]*)"/)\n          \n          setFrontmatter({\n            title: titleMatch ? titleMatch[1] : '',\n            date: dateMatch ? dateMatch[1] : '',\n            excerpt: excerptMatch ? excerptMatch[1] : ''\n          })       
...
`
      ...
      if (data.success) {
        setSuccess('✅ Artikel berhasil disimpan dan di-commit ke GitHub!')
      ...
      <header className="bg-white shadow sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <Link href="/admin/posts" className="text-purple-600 hover:text-purple-700 flex items-center gap-2">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-lg font-bold text-gray-900 mb-4">Metadata Artikel</h2>
            ...
            {/* Content Editor */}
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-lg font-bold text-gray-900 mb-4">Konten Artikel</h2>
              <TipTapEditor
                content={content}
                onChange={setContent}
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="px-8 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {saving ? (
                  <>
